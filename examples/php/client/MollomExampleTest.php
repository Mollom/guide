...
/**
 * @file
 * Mollom Example testing mode client class.
 */

/**
 * Mollom Example client implementation using testing API servers.
 */
class MollomExampleTest extends MollomExample {
  ...
  function __construct() {
    ...
    if (!isset($this->createKeys)) {
      $this->createKeys = (bool) $settings['mollom']['testing_autocreate_keys'];
    }
  ...
  public function createKeys() {
    ...
    $result = $this->createSite(array(
      ...
      'email' => 'mollom-example-test@example.com',
    ));
